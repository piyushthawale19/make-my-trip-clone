...
const BookFlightPage = () => {
  ...
  const handleSeatConfirm = (seats: string[]) => {
    ...
    // Open payment modal after seat selection
  ...
  const handlePaymentSuccess = async (paymentData: any) => {
    try {
      ...
      // Show success message and review prompt
      ...
      {user && flight && (
        <PaymentModal
          ...
          bookingDetails={{
            ...
            currency: 'USD',
            bookingType: 'FLIGHT',
            itemName: `${flight.flightName} - ${flight.from} to ${flight.to}`
          }}
